...
public class QuarterInputView extends JPanel implements ActionListener {
	...
	JPanel jp = new JPanel(new GridLayout(18, 4));
	...
	private void init() {
		...
		labels.add(new JLabel("Free throw attempts:"));
		textFields.add(new JTextField());

		jp.add(labels.get(0));
		jp.add(textFields.get(0));
		
		labels.add(new JLabel("Free throw hit:"));
		textFields.add(new JTextField());
		...
		for(int i = 0 ; i < 8 ; i += 2) {
			...
			jp.add(labels.get(14+ i));
			jp.add(textFields.get(14 + i));

			labels.add(new JLabel("3 points hit(square " + j++ + "):"));
			textFields.add(new JTextField());

			jp.add(labels.get(15 + i));
			jp.add(textFields.get(15 + i));
		...
		jp.add(labels.get(31));
		jp.add(textFields.get(31));

		labels.add(new JLabel("Assists:"));
		textFields.add(new JTextField());

		jp.add(labels.get(32));
		jp.add(textFields.get(32));

		labels.add(new JLabel("Steals:"));
		textFields.add(new JTextField());

		jp.add(labels.get(33));
		jp.add(textFields.get(33));

		labels.add(new JLabel("Blocks:"));
		textFields.add(new JTextField());

		jp.add(labels.get(34));
		jp.add(textFields.get(34));
	...
	public void saveData() {
		...
		view.getControler().processAddPoints(game_id, team, jersey, 1, total , miss, 1 , quarter);
		...
		miss = Integer.parseInt(textFields.get(23).getText());
		...
		total = Integer.parseInt(textFields.get(31).getText());
		view.getControler().processAddStat(game_id, team, jersey, "technical", total, quarter);

		total = Integer.parseInt(textFields.get(32).getText());
		view.getControler().processAddStat(game_id, team, jersey, "steal", total, quarter);

		total = Integer.parseInt(textFields.get(33).getText());
		view.getControler().processAddStat(game_id, team, jersey, "block", total, quarter);
}
