...
public class GameTeamOutputTab extends JPanel{
	...
	private void fillWithData() {
		...
		for(int i = 0 ; i < players.size(); i++) {
			...
			ft_total = view.getControler().countShots(game_id, team,Integer.parseInt(players.get(i).split(",")[0]), 1, false, 1, quarter);
			ft_in =view.getControler().countShots(game_id, team,Integer.parseInt(players.get(i).split(",")[0]), 1, true, 1, quarter);
